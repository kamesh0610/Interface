...
export default function HomeScreen() {
  ...
  const [floatingDivs, setFloatingDivs] = useState<any[]>([]);

  useEffect(() => {
    // Generate random values for the floating divs only on the client side
    const newDivs = [...Array(12)].map(() => ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-800 flex flex-col items-center justify-center text-white px-4 relative overflow-hidden">
      ...
      {floatingDivs.map((style: CSSProperties | undefined, i: Key | null | undefined) => (
        <div
          key={i}
